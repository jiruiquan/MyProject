...
#define KEY1        HAL_GPIO_ReadPin(GPIOI, GPIO_PIN_9)     /* 读取KEY1引脚 */
#define KEY2        HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_11)     /* 读取KEY2引脚 */
#define WK_UP       HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_13)     /* 读取WKUP引脚 */
